                        ...
                        <div class="row">
                            <?php
                             ...
                             <div class="col-sm-4 py-3">
                                 <div class="card prod_card shadow" style="height:550px!important; overflow-y:auto;">
                                    <div class="float-right align-top bid-tag">
                                     ...
                                     <img class="card-img-top" src="admin/assets/uploads/<?php echo $row['img_fname'] ?>" alt="Card image cap" style="max-height:350px;">
                                      <div class="float-right align-top d-flex">
                                         <span class="badge badge-pill badge-warning text-white ml-1 mt-1"><i class="fa fa-hourglass-half"></i> <?php echo date("M d,Y h:i A",strtotime($row['bid_end_datetime'])) ?></span>
                                     </div>
